package com.starface.frame.core.dao.impl;
...
import com.starface.frame.core.dao.constants.SqlId;
import com.starface.frame.core.dao.domain.Identifiable;
import com.starface.frame.core.exception.DaoException;
import com.starface.frame.core.utils.BeanUtils;
import com.starface.frame.core.utils.UUIDUtils;
...
public abstract class BaseDaoImpl<T extends Identifiable> implements BaseDao<T> {
	...
	public Long selectCount() {
		try {
			System.out.println(getSqlName(SqlId.SQL_SELECT_COUNT));
