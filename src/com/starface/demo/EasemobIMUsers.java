...
import com.easemob.common.HTTPMethod;
import com.easemob.common.Roles;
import com.easemob.utils.JerseyUtils;
import com.easemob.vo.ClientSecretCredential;
import com.easemob.vo.Credential;
import com.easemob.vo.EndPoints;
...
//        ObjectNode imUserLoginNode = imUserLogin(datanode.get("username").asText(), datanode.get("password").asText());
    	...
    	String ownerUserPrimaryKey = "47";
    	String friendUserPrimaryKey = "48";
    	ObjectNode result = addFriendSingle(ownerUserPrimaryKey, friendUserPrimaryKey);
//    	ObjectNode result = deleteFriendSingle(ownerUserPrimaryKey, friendUserPrimaryKey);
